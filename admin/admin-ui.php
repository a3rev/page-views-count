...
class WP_PVC_Admin_UI
{
	...
	public $google_api_key_option  = A3_PVC_KEY . '_google_api_key';
	public $toggle_box_open_option = A3_PVC_KEY . '_toggle_box_open';
	public $version_transient      = A3_PVC_KEY . '_licinfo';
